...
COCO_KPTS_COLORS = [
    ...
    BLUE,  # 3: left_ear
    BLUE,  # 4: right_ear
    TEAL,  # 5: left_shoulder
    YELLOW,  # 6: right_shoulder
    TEAL,  # 7: left_elbow
    YELLOW,  # 8: right_elbow
    TEAL,  # 9: left_wrist
    YELLOW,  # 10: right_wrist
    TEAL,  # 11: left_hip
    YELLOW,  # 12: right_hip
    TEAL,  # 13: left_knee
    YELLOW,  # 14: right_knee
    TEAL,  # 15: left_ankle
    YELLOW,  # 16: right_ankle
]
...
COCO_WHOLEBODY_KPTS_COLORS = [
    ...
    TEAL,  # 15: left_ankle
    YELLOW,  # 16: right_ankle
    TEAL,  # 17: left_big_toe
    TEAL,  # 18: left_small_toe
    TEAL,  # 19: left_heel
    YELLOW,  # 20: right_big_toe
    YELLOW,  # 21: right_small_toe
    YELLOW,  # 22: right_heel
    WHITE,  # 23: face-0
    WHITE,  # 24: face-1
    WHITE,  # 25: face-2
    WHITE,  # 26: face-3
    ...
    WHITE,  # 89: face-66
    WHITE,  # 90: face-67
    WHITE,  # 91: left_hand_root
    YELLOW,  # 92: left_thumb1
    YELLOW,  # 93: left_thumb2
    YELLOW,  # 94: left_thumb3
    YELLOW,  # 95: left_thumb4
    PINK,  # 96: left_forefinger1
    PINK,  # 97: left_forefinger2
    PINK,  # 98: left_forefinger3
    PINK,  # 99: left_forefinger4
    PURPLE,  # 100: left_middle_finger1
    PURPLE,  # 101: left_middle_finger2
    PURPLE,  # 102: left_middle_finger3
    PURPLE,  # 103: left_middle_finger4
    RED,  # 104: left_ring_finger1
    RED,  # 105: left_ring_finger2
    RED,  # 106: left_ring_finger3
    RED,  # 107: left_ring_finger4
    TEAL,  # 108: left_pinky_finger1
    TEAL,  # 109: left_pinky_finger2
    TEAL,  # 110: left_pinky_finger3
    TEAL,  # 111: left_pinky_finger4
    WHITE,  # 112: right_hand_root
    YELLOW,  # 113: right_thumb1
    YELLOW,  # 114: right_thumb2
    YELLOW,  # 115: right_thumb3
    YELLOW,  # 116: right_thumb4
    PINK,  # 117: right_forefinger1
    PINK,  # 118: right_forefinger2
    PINK,  # 119: right_forefinger3
    PINK,  # 120: right_forefinger4
    PURPLE,  # 121: right_middle_finger1
    PURPLE,  # 122: right_middle_finger2
    PURPLE,  # 123: right_middle_finger3
    PURPLE,  # 124: right_middle_finger4
    RED,  # 125: right_ring_finger1
    RED,  # 126: right_ring_finger2
    RED,  # 127: right_ring_finger3
    RED,  # 128: right_ring_finger4
    TEAL,  # 129: right_pinky_finger1
    TEAL,  # 130: right_pinky_finger2
    TEAL,  # 131: right_pinky_finger3
    TEAL,  # 132: right_pinky_finger4
]
...
COCO_SKELETON_INFO = {
    0: dict(link=(15, 13), id=0, color=TEAL),
    1: dict(link=(13, 11), id=1, color=TEAL),
    2: dict(link=(16, 14), id=2, color=YELLOW),
    3: dict(link=(14, 12), id=3, color=YELLOW),
    4: dict(link=(11, 12), id=4, color=BLUE),
    5: dict(link=(5, 11), id=5, color=BLUE),
    6: dict(link=(6, 12), id=6, color=BLUE),
    7: dict(link=(5, 6), id=7, color=BLUE),
    8: dict(link=(5, 7), id=8, color=TEAL),
    9: dict(link=(6, 8), id=9, color=YELLOW),
    10: dict(link=(7, 9), id=10, color=TEAL),
    11: dict(link=(8, 10), id=11, color=YELLOW),
    12: dict(link=(1, 2), id=12, color=BLUE),
    13: dict(link=(0, 1), id=13, color=BLUE),
    14: dict(link=(0, 2), id=14, color=BLUE),
    15: dict(link=(1, 3), id=15, color=BLUE),
    16: dict(link=(2, 4), id=16, color=BLUE),
    17: dict(link=(3, 5), id=17, color=BLUE),
    18: dict(link=(4, 6), id=18, color=BLUE),
}


COCO_WHOLEBODY_SKELETON_INFO = {
    0: dict(link=(15, 13), id=0, color=TEAL),  # left leg
    1: dict(link=(13, 11), id=1, color=TEAL),  # left leg
    2: dict(link=(16, 14), id=2, color=YELLOW),  # right leg
    3: dict(link=(14, 12), id=3, color=YELLOW),  # right leg
    4: dict(link=(11, 12), id=4, color=BLUE),  # body
    5: dict(link=(5, 11), id=5, color=GREEN),  # body
    6: dict(link=(6, 12), id=6, color=ORANGE),  # body
    7: dict(link=(5, 6), id=7, color=BLUE),  # body
    8: dict(link=(5, 7), id=8, color=TEAL),
    9: dict(link=(6, 8), id=9, color=YELLOW),
    10: dict(link=(7, 9), id=10, color=TEAL),
    11: dict(link=(8, 10), id=11, color=YELLOW),
    12: dict(link=(1, 2), id=12, color=BLUE), # left eye to right eye
    13: dict(link=(0, 1), id=13, color=GREEN), # nose to left eye
    14: dict(link=(0, 2), id=14, color=ORANGE), # nose to right eye
    15: dict(link=(1, 3), id=15, color=GREEN), # left eye to ear
    16: dict(link=(2, 4), id=16, color=ORANGE), # right eye to ear
    17: dict(link=(3, 5), id=17, color=GREEN), # left ear to shoulder
    18: dict(link=(4, 6), id=18, color=ORANGE), # right ear to shoulder
    19: dict(link=(15, 17), id=19, color=TEAL),  # left foot
    20: dict(link=(15, 18), id=20, color=TEAL),  # left foot
    21: dict(link=(15, 19), id=21, color=TEAL),  # left foot
    22: dict(link=(16, 20), id=22, color=YELLOW),  # right foot
    23: dict(link=(16, 21), id=23, color=YELLOW),  # right foot
    24: dict(link=(16, 22), id=24, color=YELLOW),  # right foot
    25: dict(link=(91, 92), id=25, color=YELLOW),
    26: dict(link=(92, 93), id=26, color=YELLOW),
    27: dict(link=(93, 94), id=27, color=YELLOW),
    28: dict(link=(94, 95), id=28, color=YELLOW),
    29: dict(link=(91, 96), id=29, color=PINK),
    30: dict(link=(96, 97), id=30, color=PINK),
    31: dict(link=(97, 98), id=31, color=PINK),
    32: dict(link=(98, 99), id=32, color=PINK),
    33: dict(link=(91, 100), id=33, color=PURPLE),
    34: dict(link=(100, 101), id=34, color=PURPLE),
    35: dict(link=(101, 102), id=35, color=PURPLE),
    36: dict(link=(102, 103), id=36, color=PURPLE),
    37: dict(link=(91, 104), id=37, color=RED),
    38: dict(link=(104, 105), id=38, color=RED),
    39: dict(link=(105, 106), id=39, color=RED),
    40: dict(link=(106, 107), id=40, color=RED),
    41: dict(link=(91, 108), id=41, color=TEAL),
    42: dict(link=(108, 109), id=42, color=TEAL),
    43: dict(link=(109, 110), id=43, color=TEAL),
    44: dict(link=(110, 111), id=44, color=TEAL),
    45: dict(link=(112, 113), id=45, color=YELLOW),
    46: dict(link=(113, 114), id=46, color=YELLOW),
    47: dict(link=(114, 115), id=47, color=YELLOW),
    48: dict(link=(115, 116), id=48, color=YELLOW),
    49: dict(link=(112, 117), id=49, color=PINK),
    50: dict(link=(117, 118), id=50, color=PINK),
    51: dict(link=(118, 119), id=51, color=PINK),
    52: dict(link=(119, 120), id=52, color=PINK),
    53: dict(link=(112, 121), id=53, color=PURPLE),
    54: dict(link=(121, 122), id=54, color=PURPLE),
    55: dict(link=(122, 123), id=55, color=PURPLE),
    56: dict(link=(123, 124), id=56, color=PURPLE),
    57: dict(link=(112, 125), id=57, color=RED),
    58: dict(link=(125, 126), id=58, color=RED),
    59: dict(link=(126, 127), id=59, color=RED),
    60: dict(link=(127, 128), id=60, color=RED),
    61: dict(link=(112, 129), id=61, color=TEAL),
    62: dict(link=(129, 130), id=62, color=TEAL),
    63: dict(link=(130, 131), id=63, color=TEAL),
    64: dict(link=(131, 132), id=64, color=TEAL),
}
